class User < ApplicationRecord
  ...
  with_options presence: true do
    validates :password, on: :create,  format: {with: /\A[a-z0-9]+\z/i, message: "is invalid. Input half-width characters."}
    validates :nickname#, format: {with: /\A[ぁ-んァ-ヶ一-龥々]+\z/, message: "is invalid. Input full-width characters."}
